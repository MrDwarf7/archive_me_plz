...
Usage: archive_me_plz [qualifier oldest_to_keep folder_path] -> [output]
    ...
    info:
    qualifier:          The minimum number of files required to qualify a folder for archiving
    ...
    The files in /home/user/folder_with_lots_of_files will be
    qualified if it contains 5 or more files.
